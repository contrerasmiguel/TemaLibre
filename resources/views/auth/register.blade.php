                ...
                <div class="row">
                    <form role="form">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="nombre_usuario" placeholder="Ejemplo: campanitas69" value="{{ old('nombre_usuario') }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="col-md-offset-3 col-md-3">
                            <button type="submit" formaction="/auth/register" formmethod="POST" class="btn btn-success btn-block">
                                <span class="glyphicon glyphicon-check"></span>&nbspRegistrarse
                            </button>
                        </div>
                        <div class="col-md-3">
